...
_(o8C,c9C)
var lAD=_n('view')
_rz(z,lAD,'style',3,e,s,gg)
var aBD=_oz(z,4,e,s,gg)
_(lAD,aBD)
var tCD=_mz(z,'text',['bindtap',5,'data-event-opts',1,'style',2],[],e,s,gg)
...
var x9D=_n('view')
_rz(z,x9D,'class',38,e6D,t5D,gg)
var o0D=_n('view')
_rz(z,o0D,'class',39,e6D,t5D,gg)
var fAE=_oz(z,40,e6D,t5D,gg)
_(o0D,fAE)
_(x9D,o0D)
var cBE=_n('view')
_rz(z,cBE,'class',41,e6D,t5D,gg)
var hCE=_mz(z,'view',['bindtap',42,'data-artid',1,'data-event-opts',2],[],e6D,t5D,gg)
var oDE=_oz(z,45,e6D,t5D,gg)
_(hCE,oDE)
_(cBE,hCE)
var cEE=_mz(z,'view',['bindtap',46,'data-artid',1,'data-event-opts',2,'data-index',3],[],e6D,t5D,gg)
var oFE=_oz(z,50,e6D,t5D,gg)
_(cEE,oFE)
_(cBE,cEE)
_(x9D,cBE)
_(b7D,x9D)
...
l3D.wxXCkey=2
_2z(z,36,a4D,e,s,gg,l3D,'item','index','index')
var lGE=_n('view')
...
var xME=_mz(z,'input',['bindinput',2,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
_(oLE,xME)
_(eJE,oLE)
var oNE=_n('view')
...
var lUE=_v()
_(cSE,lUE)
if(_oz(z,12,oRE,hQE,gg)){lUE.wxVkey=1
var tWE=_n('view')
_rz(z,tWE,'class',13,oRE,hQE,gg)
var eXE=_mz(z,'image',['bindtap',14,'data-event-opts',1,'data-index',2,'mode',3,'src',4],[],oRE,hQE,gg)
_(tWE,eXE)
_(lUE,tWE)
}
var aVE=_v()
...
var bYE=_n('view')
_rz(z,bYE,'class',20,oRE,hQE,gg)
var oZE=_mz(z,'textarea',['placeholder',-1,'bindinput',21,'data-event-opts',1,'value',2],[],oRE,hQE,gg)
_(bYE,oZE)
var x1E=_mz(z,'view',['bindtap',24,'class',1,'data-event-opts',2,'data-index',3],[],oRE,hQE,gg)
var o2E=_oz(z,28,oRE,hQE,gg)
_(x1E,o2E)
_(bYE,x1E)
_(aVE,bYE)
}
...
fOE.wxXCkey=2
_2z(z,10,cPE,e,s,gg,fOE,'item','index','index')
_(eJE,oNE)
var f3E=_mz(z,'form',['bindsubmit',29,'data-event-opts',1],[],e,s,gg)
var c4E=_n('view')
...
var o8E=_mz(z,'textarea',['bindinput',37,'data-event-opts',1,'maxlength',2,'name',3,'placeholder',4,'value',5],[],e,s,gg)
_(c7E,o8E)
var l9E=_mz(z,'button',['formType',43,'type',1],[],e,s,gg)
var a0E=_oz(z,45,e,s,gg)
_(l9E,a0E)
_(c7E,l9E)
_(c4E,c7E)
_(f3E,c4E)
...
_(tAF,eBF)
var oDF=_n('view')
var xEF=_mz(z,'picker',['bindchange',48,'data-array',1,'data-event-opts',2,'range',3,'rangeKey',4,'value',5],[],e,s,gg)
var oFF=_n('view')
...
var bKE=_v()
_(eJE,bKE)
if(_oz(z,55,e,s,gg)){bKE.wxVkey=1
